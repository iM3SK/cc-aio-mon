...
**Architecture:**
- `monitor.py` keeps an explicit section index and a 3800-line maintainability trigger for the single-file TUI module.
...
- `tests/test_monitor.py::TestAuditRegressionV1105::test_debt016_monitor_loc_tripwire` - DEBT-016 trigger: `monitor.py` exceeding the LOC threshold fails with a maintainability guard before further growth.
